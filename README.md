...
Ebenso ist eine Notebook enthalten (Code/train_all_models.ipynb), welches für das Cloud-Training erstellt wurde. Dieses Notebook importiert das Repository, Importiert alle Bibliotheken aus der requirements.py Datei und ruft die Traningsskripte auf. Anpassungen wie Optunaläufe oder Parametereinstellungen erfolgen in den Skripten selbst.
